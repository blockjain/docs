...
This unique identifier becomes the anchor point for associating Data Assets with you while safeguarding other sensitive aspects of your identity, such as email addresses and wallet information.
...
This unification empowers you to manage Data Assets through a single user-friendly interface. To learn more about the different identities you can aggregate, visit the User Tab here.

Uniquely, Gateway ID removes barriers to entry by allowing instant participation in the network.

Issuers can send Data Assets to any supported authentication methods; if an associated Gateway ID doesn’t already exist, one will be automatically initialized for the user.
