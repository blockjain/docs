...
<img
  height="200"
  src="/assets/gateway-network/gateway-architecture.png"
...
Validators can also store user data. Data Assets issued to users will be stored encrypted at rest with a keypair controlled by the owner.
