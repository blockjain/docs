...
This page contains practical examples of using Gateway's garbled circuits for privacy-preserving computations. For more examples and the complete source code, visit our [GitHub repository](https://github.com/Gateway-DAO/gvm/tree/main/compute/examples).
...
You can find more examples in our [GitHub repository](https://github.com/Gateway-DAO/gvm/tree/main/compute/examples). Each example includes detailed comments and test cases. The repository also contains additional utilities and helper functions.