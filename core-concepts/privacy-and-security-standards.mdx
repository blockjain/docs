...
TODO - remove references to ARWEAVE
...
```
TODO - will require updates with Compute

why x/y/z primitives are secure/verifiable
...
```
TODO - remove arweave, update from EDV page. can come up with paragraph to replace this
