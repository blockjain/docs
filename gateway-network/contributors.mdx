...
3. **Issuing Private Data Assets(PDAs)**: Once you've selected a data model, you can start issuing PDAs. PDAs are the actual data you want to contribute. You can contribute PDAs to your users or to other entities in the network.
...
Here is a video tutorial on how to contribute data:
...
<Accordion title="What is the contributor responsible/liable for?">
  ...
  **[support@mygateway.xyz](mailto:support@mygateway.xyz)**. 3. Contributors
  ...
  [widget]() and also allows to send notification emails to the recipients of
  the data.
</Accordion>

  <Accordion title="How can I contributor data directly through the protocol?">
    
    You can utilize the API/SDK [here](/sdk/introduction) to contributor directly into the protocol. This offers the most flexibility in terms of customization of data contribution.
