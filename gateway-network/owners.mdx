...
TODO - update with content around ACL access roles/permissions

"contributors and owners"

possibly remove "roles section" with a single page about 1-to-many relationship

reference notion docs - https://www.notion.so/mygateway/Data-Assets-Permissions-113e39c3259380f8b119f4769ef51cbc?pvs=4


rest of this can be removed/replaced

```

![Owner Intro](/assets/roles/owners-intro.png)
...
As sovereign guardians of their data, they hold the exclusive right to selectively distribute and grant access to verifiers within the network. This data, manifested in the form of Data Assets, is sourced from issuers.
...
![Owner's Functions](/assets/roles/owners-functions.png)
