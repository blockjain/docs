...
As sovereign guardians of their data, they hold the exclusive right to selectively distribute and grant access to verifiers within the network. This data, manifested in the form of Private Data Assets (PDAs), is sourced from issuers.
...
<img height="200" src="/assets/roles/owners-flow.png" />
