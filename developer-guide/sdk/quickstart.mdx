...
The endpoint URL for creation of Gateway instance is

`https://protocol.mygateway.xyz/graphql` for the Mainnet.

`https://sandbox.protocol.mygateway.xyz/graphql` for the Sandbox Environment.
