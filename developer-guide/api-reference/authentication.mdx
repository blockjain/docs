...
1. Open the [`auth/message` endpoint](/developer-guide/api-reference/auth/generate-sign-message) and click **Send**
2. Copy the output of the [`message`](/developer-guide/api-reference/auth/generate-sign-message) field from the response body.
...
4. Create an account using the [`/accounts` endpoint](/developer-guide/api-reference/accounts/create-account)
...
5. Verify the account and token by using the [`accounts/me` endpoint](/developer-guide/api-reference/accounts/get-my-account)
